  ...
  loadMeting = function () {
    function a(a, t) {
      ...
      if (t.length) {
        ...
        if (!document.querySelector("#global-aplayer > div.aplayer-body > div.aplayer-info > div.aplayer-controller > div.aplayer-time.aplayer-time-narrow > button.aplayer-icon.aplayer-icon-lrc.aplayer-icon-lrc-inactivity")) {
            document.querySelector("#global-aplayer > div.aplayer-body > div.aplayer-info > div.aplayer-controller > div.aplayer-time.aplayer-time-narrow > button.aplayer-icon.aplayer-icon-lrc").click();
        }
      }
    }
    var t =
      "https://meting-api.shineyu.cn/api/?server=:server&type=:type&id=:id&auth=:auth&r=:r";
